...
<!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
  ...
  <script src="<?php echo e(asset('dashboard/assets/vendor/js/template-customizer.js')); ?>"></script>
<?php endif; ?>
        ...
        pathResolver: function(path) {
            var resolvedPaths = {
                ...
                <?php $__currentLoopData = ['core']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    '<?php echo e($name); ?>.css': '<?php echo e(asset("dashboard/assets/vendor/css{$configData['rtlSupport']}/{$name}.css")); ?>',
                    '<?php echo e($name); ?>-dark.css': '<?php echo e(asset("dashboard/assets/vendor/css{$configData['rtlSupport']}/{$name}-dark.css")); ?>',
                ...
                <?php $__currentLoopData = ['default', 'bordered', 'semi-dark']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    'theme-<?php echo e($name); ?>.css': '<?php echo e(asset("dashboard/assets/vendor/css{$configData['rtlSupport']}/theme-{$name}.css")); ?>',
                    'theme-<?php echo e($name); ?>-dark.css': '<?php echo e(asset("dashboard/assets/vendor/css{$configData['rtlSupport']}/theme-{$name}-dark.css")); ?>',
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            }
...
<?php endif; ?>
<?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/layouts/sections/scriptsIncludes.blade.php ENDPATH**/ ?>