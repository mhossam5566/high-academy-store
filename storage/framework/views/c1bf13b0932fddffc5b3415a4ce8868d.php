...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        ...
        <a href="<?php echo e(route('dashboard.create.main_categories')); ?>" class="btn btn-primary">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#categoriesTable').DataTable({
                ...
                ajax: {
                    url: '<?php echo e(route('dashboard.main_categories.datatable')); ?>',
                    type: 'GET'
                },
                columns: [
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route('dashboard.main_categories.destroy')); ?>',
                            type: "POST",
                            data: {
...
<?php echo $__env->make('dashboard.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/pages/main_category/index.blade.php ENDPATH**/ ?>