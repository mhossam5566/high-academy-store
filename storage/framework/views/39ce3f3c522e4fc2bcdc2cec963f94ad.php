    ...
    <div class="container-fluid">
        <nav class="navbar">
            ...
            <ul class="header-right justify-content-end d-flex align-items-center mb-0">
                ...
                <li>
                    <div class="dropdown morphing scale-right notifications">
                                    ...
                                    <div class="tab-pane fade show active" id="Noti-tab-Message"
                                        ...
                                        <ul class="list-unstyled list mb-0">
                                            <li class="py-2 mb-1 border-bottom">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="<?php echo e(url('/')); ?>/admin/assets/img/xs/avatar5.jpg" alt="">
                                            ...
                                            <li class="py-2 mb-1 border-bottom">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="<?php echo e(url('/')); ?>/admin/assets/img/xs/avatar6.jpg" alt="">
                                                    <div class="flex-fill ms-3">
                                                        <p class="d-flex justify-content-between mb-0"><span>Del
                                                                Phineum</span> <small>1HR</small></p>
                                            ...
                                            <li class="py-2 mb-1 border-bottom">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="<?php echo e(url('/')); ?>/admin/assets/img/xs/avatar1.jpg" alt="">
                                                    <div class="flex-fill ms-3">
                                                        <p class="d-flex justify-content-between mb-0">
                                                ...
                                                <a href="javascript:void(0);" class="d-flex">
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        <p class="d-flex justify-content-between mb-0"><span>Pat
                                                                Thettick</span> <small>13MIN</small></p>
                                            ...
                                            <li class="py-2 mb-1 border-bottom">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="<?php echo e(url('/')); ?>/admin/assets/img/xs/avatar3.jpg" alt="">
                                                    <div class="flex-fill ms-3">
                                                        <p class="d-flex justify-content-between mb-0">
                                            ...
                                            <li class="py-2 mb-1 border-bottom">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="<?php echo e(url('/')); ?>/admin/assets/img/xs/avatar4.jpg" alt="">
                                                    <div class="flex-fill ms-3">
                                                        <p class="d-flex justify-content-between mb-0">
                                            ...
                                            <li class="py-2">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="<?php echo e(url('/')); ?>/admin/assets/img/xs/avatar7.jpg" alt="">
                                                    <div class="flex-fill ms-3">
                                                        <p class="d-flex justify-content-between mb-0">
                                                ...
                                                <a href="javascript:void(0);" class="d-flex">
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        <p class="mb-0">Website visits from Twitter is <strong
                                                                class="text-danger">27% higher</strong> than
                                                            last week.</p>
                ...
                <li class="d-none d-xl-inline-block">
                    <div class="dropdown morphing scale-right Language mx-sm-2">
                        <a class="nav-link dropdown-toggle after-none" href="#" role="button"
                            data-bs-toggle="dropdown">
                            <svg viewBox="0 0 16 16" width="18px" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="d-none d-lg-inline-block">
                    <div class="dropdown morphing scale-right grid-menu mx-sm-2">
                        <a class="nav-link dropdown-toggle after-none" href="#" role="button"
                            data-bs-toggle="dropdown">
                            <svg viewBox="0 0 16 16" width="18px" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="dropdown morphing scale-right user-profile mx-lg-3 mx-2">
                        <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button"
                            ...
                            <img class="avatar img-thumbnail rounded-circle shadow"
                                src="<?php echo e(asset('storage/images/admins/'.auth()->user()->photo)); ?>" alt="">
                        </a>
                        <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                            <div class="card border-0 w240">
                                <div class="card-body border-bottom d-flex">
                                    <img class="avatar rounded-circle" 
                                    src="<?php echo e(asset('/storage/images/admins/'.auth()->user()->photo)); ?>"
                                        alt="">
                                    <div class="flex-fill ms-3">
                                        <h6 class="card-title mb-0"><?php echo e(auth()->user()->name); ?></h6>
                                        <span class="text-muted"><a href="/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="1d7c717174787a6f7c69786f5d71687372337e7270"><?php echo e(auth()->user()->email); ?></a></span>
                                    </div>
                                   <h5>
                                </div>
                                <div class="list-group m-2 mb-3">
                                    <a class="list-group-item list-group-item-action border-0"
                                        href="<?php echo e(route('dashboard.profile')); ?>"><i class="w30 fa fa-user"></i>My Profile</a>
                                    <a class="list-group-item list-group-item-action border-0"
...
<?php /**PATH E:\laravel\High_Academy\resources\views/admin/includs/nav.blade.php ENDPATH**/ ?>