        ...
        <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <li class="menu-item <?php echo e($activeClass); ?>">
                ...
                <?php if(isset($submenu->submenu)): ?>
                    <?php echo $__env->make('dashboard.layouts.sections.menu.submenu', ['menu' => $submenu->submenu], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
</ul>
<?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/layouts/sections/menu/submenu.blade.php ENDPATH**/ ?>