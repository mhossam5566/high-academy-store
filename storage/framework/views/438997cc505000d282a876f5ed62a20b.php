<?php $__env->startSection('title', 'إضافة صف دراسي'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <h4 class="mb-0">
            <span class="text-muted fw-light">الصفوف الدراسية /</span> إضافة صف دراسي جديد
        </h4>
    </div>

    <form action="<?php echo e(route('dashboard.store.slider')); ?>" method="POST" data-validate class="needs-validation" novalidate
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        <label class="form-label d-block mb-1">صورة السلايدر (اختياري)</label>
        ...
        <div class="card">
            <div class="card-body text-end">
                <button type="submit" class="btn btn-primary">حفظ السلايدر</button>
            </div>
        </div>
...
<?php echo $__env->make('dashboard.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/pages/slider/create.blade.php ENDPATH**/ ?>