...
<?php $__env->startSection('content'); ?>
    ...
    <form id="productForm" data-ajax data-redirect="<?php echo e(route('dashboard.product')); ?>"
          action="<?php echo e(route('dashboard.store.product')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="tab-content">
                            <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane fade <?php echo e($index === 0 ? 'show active' : ''); ?>" id="name-<?php echo e($locale); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                              placeholder="أدخل الوصف (<?php echo e(strtoupper($locale)); ?>)"></textarea>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="max_qty_for_order" class="form-control" placeholder="اتركه فارغاً لعدم التحديد">
                    </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="offer_value" id="offer_value" value="0" step="0.01" class="form-control">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="main_category_id" id="main_categories" class="form-select select2">
                            ...
                            <?php $__currentLoopData = $main_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $main_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($main_category->id); ?>"><?php echo e($main_category->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php echo $__env->make('dashboard.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/pages/Product/create.blade.php ENDPATH**/ ?>