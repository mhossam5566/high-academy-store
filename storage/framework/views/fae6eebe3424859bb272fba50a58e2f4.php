...
<head>
    ...
    <?php echo $__env->make('user.layouts.css', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
     <style>
...
<body class="no-scroll" style="font-family: --font-family-sans-serif !important;">
    ...
    <!-- Navbar Start -->
    <div id="header-ajax">
        <?php echo $__env->make('user.layouts.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    <!-- Navbar End -->
    ...
    <?php echo $__env->make('user.layouts.js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
   <script>
...
<?php /**PATH E:\laravel\High_Academy\resources\views/user/layouts/master.blade.php ENDPATH**/ ?>