            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item <?php echo e(app()->getLocale() === 'fr' ? 'active' : ''); ?>"
                        href="<?php echo e(url('lang/fr')); ?>" data-language="fr" data-text-direction="ltr">
                ...
                <li>
                    <a class="dropdown-item <?php echo e(app()->getLocale() === 'de' ? 'active' : ''); ?>"
                        href="<?php echo e(url('lang/de')); ?>" data-language="de" data-text-direction="ltr">
            ...
            <ul class="dropdown-menu dropdown-menu-end py-0" style="max-width: 380px;">
                <li class="dropdown-menu-header border-bottom">
                    <div class="dropdown-header d-flex align-items-center py-3">
                        ...
                        <a href="<?php echo e(url('/orders')); ?>" class="dropdown-notifications-all text-body"
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    <img src="<?php echo e(Auth::user() ? Auth::user()->profile_photo_url : asset('dashboard/assets/img/avatars/1.png')); ?>"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Initialize Ably
        const ably = new Ably.Realtime('<?php echo e(config('broadcasting.connections.ably.key')); ?>');
        ...
        function playSound() {
            const audio = new Audio('<?php echo e(asset('dashboard/assets/sounds/notification.mp3')); ?>');
            audio.volume = 0.5;
        ...
        function createNotif(order) {
            const n = new Notification('🛒 طلب جديد!', {
                ...
                icon: '<?php echo e(asset('dashboard/assets/img/icons/cart.png')); ?>',
...
<?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/layouts/sections/navbar/navbar.blade.php ENDPATH**/ ?>