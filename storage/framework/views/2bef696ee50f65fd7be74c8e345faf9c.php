<?php $__env->startSection('title', 'إضافة مدرس جديد'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <h4 class="mb-0">
            <span class="text-muted fw-light">المدرسين /</span> إضافة جديد
        </h4>
    ...
    <form id="brandForm" data-ajax data-redirect="<?php echo e(route('dashboard.teachers')); ?>"
          action="<?php echo e(route('dashboard.store.teachers')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               data-default-file="" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png gif">
...
<?php echo $__env->make('dashboard.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/pages/Brand/create.blade.php ENDPATH**/ ?>