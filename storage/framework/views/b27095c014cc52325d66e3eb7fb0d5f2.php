<?php $__currentLoopData = $mostOrderedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
    ...
    <div class="col-xxl-5-cols col-xl-3 col-lg-4  col-6 pb-1">
        ...
        <div class="product-item bg-light mb-4 position-relative d-flex flex-column justify-content-between rounded-5"
         ...
         <?php else: ?>
         <?php endif; ?>
            <a href="<?php echo e(route('user.product.show', $item->id)); ?>" class="text-decoration-none ">
                <div class="product-img ">
                    <div class="overflow-hidden w-100 position-relative"
                         style="border-top-left-radius: 20px;border-top-right-radius: 20px;">


                        <img class="img-fluid w-100 lazy product-image" data-src="<?php echo e($item->image_path); ?>"
                             alt="صوره المنتج <?php echo e($item->name); ?>"/>
                    ...
                    <div class="mt-3 p-2 text-center fw-bold text-decoration-none lh-base text-center m-0">
                        ...
                        <p class="mt-2 font-size fw-lighter text-black">
                            <?php echo e($item->category ? $item->category->title . ' - ' : ''); ?>

                            <?php echo e($item->brands ? $item->brands->title . ' - ' : ''); ?>

                            <?php echo e($item->sliders->title ?? ''); ?>
                ...
                <div class="row gy-4 align-items-center justify-content-center w-100 mt-4 px-sm-4 px-md-0">
                    <div class="col-md-6 col-12">
                        <div class="d-flex flex-column align-items-center align-items-md-start  price ">
                            <?php if($item->have_offer == 1): ?>
                                <h5 class="fs-5 fw-bold mb-0">
                                    <span>EGP</span>
                                    <span class="text-primary">
                                        <?php echo e(getOfferPrice($item)); ?></span>
                                </h5>
            ...
            ">
                                        <?php if($item->offer_type == 'percentage'): ?>
                                            خصم <?php echo e($item->offer_value); ?> % لفتره محدودة
                                        <?php else: ?>
                                            خصم <?php echo e($item->offer_value); ?> جنيه لفتره محدودة
                                        <?php endif; ?>
                                    </span>
                                </div>
                            <?php else: ?>
                    ...
                    <div class="col-md-6 col-12">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if($item->state == 1 && $item->quantity > 0): ?>
                                <div
                            ...
                            <div class="col-12">
                                <div
                                    ...
                                    <a class="add_to_cart btn add-btn btn-square text-black px-4 py-4 rounded w-100"
                                       id="add_to_cart<?php echo e($item->id); ?>" data-quantity="1"
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        let mostOrderedProducts = <?php echo json_encode($mostOrderedProducts, 15, 512) ?>;
...
<?php /**PATH E:\laravel\High_Academy\resources\views/user/layouts/product_most_buyed.blade.php ENDPATH**/ ?>