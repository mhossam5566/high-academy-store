...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        ...
        <a href="<?php echo e(route('dashboard.create.category')); ?>" class="btn btn-primary">إضافة مادة دراسية</a>
    </div>
...
<?php $__env->startSection('page-script'); ?>
    <script>
        CRUDHelper.init({
            ...
            ajaxUrl: '<?php echo e(route('dashboard.category.datatable')); ?>',
            columns: [
                { data: 'id', name: 'id' },
...
<?php echo $__env->make('dashboard.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/pages/Category/index.blade.php ENDPATH**/ ?>