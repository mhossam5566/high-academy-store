<?php $__env->startSection('title', 'تعديل مادة دراسية'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <h4 class="mb-0">
            <span class="text-muted fw-light">المواد الدراسية /</span> تعديل
        </h4>
    ...
    <div class="card">
        <div class="card-body">
            <form id="categoryForm" data-ajax data-redirect="<?php echo e(route('dashboard.category')); ?>" 
                  action="<?php echo e(route('dashboard.category.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               value="<?php echo e($category->translate($locale)->title); ?>"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="file" name="photo" 
                                       data-default-file="<?php echo e($category->image_path); ?>" 
                                       class="dropify <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 text-center mt-4">
                        <button type="submit" class="btn btn-primary">تحديث المادة الدراسية</button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('dashboard.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/pages/Category/edit.blade.php ENDPATH**/ ?>