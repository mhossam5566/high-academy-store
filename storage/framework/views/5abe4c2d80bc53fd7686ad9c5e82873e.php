...
<script>
    $(document).on('click', '.add_to_cart', function(e) {
        ...
        var path = "<?php echo e(route('user.cart.store')); ?>";
...
<script>
    $(document).on('click', '.cart_delete', function(e) {
        ...
        var token = "<?php echo e(csrf_token()); ?>";
        var path = "<?php echo e(route('user.cart.delete')); ?>";
...
<script>
    ...
    function update_cart(id, productQuantity) {
        ...
        var token = "<?php echo e(csrf_token()); ?>";
        var path = "<?php echo e(route('user.cart.update')); ?>";
...
<script>
    $(document).on("click", ".login", function () {
      swal({
        ...
        window.location.href = '<?php echo e(route('user.register.user')); ?>'; // Redirect to the register page
      });
    });
  </script>
<!-- End Cart Script -->
<?php /**PATH E:\laravel\High_Academy\resources\views/user/layouts/js.blade.php ENDPATH**/ ?>