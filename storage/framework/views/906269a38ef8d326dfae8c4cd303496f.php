        ...
        <div class="app-brand demo">
            <a href="<?php echo e(url('/')); ?>" class="app-brand-link">
                <span class="app-brand-logo demo">
                    <?php echo $__env->make('dashboard._partials.macros', ['height' => 20], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </span>
            ...
            <?php else: ?>
                ...
                <li class="menu-item <?php echo e($activeClass); ?>">
                    ...
                    <?php if(isset($menu->submenu)): ?>
                        <?php echo $__env->make('dashboard.layouts.sections.menu.submenu', ['menu' => $menu->submenu], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>
                </li>
            <?php endif; ?>
...
<?php /**PATH E:\laravel\High_Academy\resources\views/dashboard/layouts/sections/menu/verticalMenu.blade.php ENDPATH**/ ?>