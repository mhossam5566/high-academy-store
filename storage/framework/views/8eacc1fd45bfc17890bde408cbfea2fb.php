    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                "sort": false,
                "ajax": {
                    "url": "<?php echo e(route('dashboard.slider.datatable')); ?>",
                    "type": "GET"
                },
                "columns": [{
                        data: 'id',
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.delete_btn', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('dashboard.slider.destroy')); ?>',
                    type: "POST",
                    dataType: "json",
                    data: {
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/admin/slider/index.blade.php ENDPATH**/ ?>