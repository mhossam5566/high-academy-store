        ...
        <div class="row px-xl-5 pt-5 g-1 align-items-center">
                    ...
                    <ol class="carousel-indicators">
                        <?php if(isset($offers) && $offers->count() > 0): ?>
                            <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li data-target="#header-carousel" data-slide-to="<?php echo e($index); ?>"
                    ...
                    <div class="carousel-inner">
                        <?php if(isset($offers) && $offers->count() > 0): ?>
                            <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($offer->image_path)): ?>
                                    ...
                                    <div class="carousel-item d-flex justify-content-center position-relative <?php echo e($index === 0 ? 'active' : ''); ?>"
                                        style="height: 350px;">
                                        <img class="position-absolute"
                                            src="<?php echo e(asset('storage/images/offers/' . $offer->image)); ?>" alt="carousel image"
                                        ...
                                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-end mb-4"
                                            ...
                                            <div class="p-3" style="max-width: 700px;">
                                                <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp"
                                                    href="<?php echo e(route('user.shop')); ?>"> جميع الكتب </a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                        ...
                        <?php else: ?>
                            <div class="carousel-item position-relative active" style="height: 350px;">
                                <img class="position-absolute w-100 h-100" src="<?php echo e(asset('default-carousel-image.jpg')); ?>"
            ...
            <div class="col-lg-6 col-12" style="padding: 0 10px 0 15px !important;">
                ...
                <div class="row justify-content-center align-items-center gx-1 gy-4">
                    <?php echo $__env->make('user.layouts.categories', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            <!-- Categories End -->
            ...
            <!--                <img class="img-fluid" src="<?php echo e(asset('/front')); ?>/img/offer-1.jpg" alt=" offer image">-->
            <!--                <div class="offer-text">-->
            <!--                    <h6 class="text-white text-uppercase"> 20% وفر </h6>-->
            <!--                    <h3 class="text-white mb-3">أكواد المدرسين</h3>-->
            <!--                    <a href="<?php echo e(route('user.evouchers')); ?>" class="btn btn-primary">أشتري الان </a>-->
            <!--                </div>-->
            <!--            </div>-->
            <!--            <div class="product-offer mb-30" style="height: 159px;">-->
            <!--                <img class="img-fluid" src="<?php echo e(asset('/front')); ?>/img/offer-2.jpg" alt=" offer image">-->
            <!--                <div class="offer-text">-->
            <!--                    <h6 class="text-white text-uppercase">عروض حصرية</h6>-->
            <!--                    <h3 class="text-white mb-3">مذكراتنا الحصريه </h3>-->
            <!--                    <a href="<?php echo e(route('user.shop')); ?>" class="btn btn-primary"> أشتري الان </a>-->
            <!--                </div>-->
            <!--            </div>-->
            <!--        </div>-->
            <!--    </div>-->
            ...
            <div class="container-fluid pt-5 pb-3">
                ...
                <div class="row px-xl-5 g-5">
                    <?php echo $__env->make('user.layouts.product_most_buyed', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                                <a class="text-decoration-none"
                                    href="<?php echo e(route('user.shop')); ?>?brand_id=<?php echo e($item->id); ?>">
                                    <div class="cat-item d-flex align-items-center mb-4">
                                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                                            <img class="img-fluid lazy" data-src="<?php echo e($item->image_path); ?>"
                                                alt=" صوره المدرس <?php echo e($item->name); ?>">
                                        </div>
                                        <div class="flex-fill pl-3">
                                            <h6> <?php echo e($item->title); ?> </h6>
                                            <small class="text-body"><?php echo e($item->description); ?> </small>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="container-fluid pt-5 pb-3">
                ...
                <div class="row px-xl-5 g-5">
                    <?php echo $__env->make('user.layouts.product', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
            <!-- new book End -->
...
<!--End of Tawk.to Script-->
<?php echo $__env->make('user.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laravel\High_Academy\resources\views/user/index.blade.php ENDPATH**/ ?>