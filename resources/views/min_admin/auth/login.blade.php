                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            <form class="row g-3" id="form" method="POST" action="{{ route('miniadmin.signin') }}">
                                @csrf
                                ...
                                <div class="col-12 text-center mb-4">
                                    <a class="btn btn-lg btn-outline-secondary btn-block" href="#">
                                        <span class="d-flex justify-content-center align-items-center">
                                            <img class="avatar xs me-2" src="{{url('/')}}/admin/assets/img/google.svg"
                                    ...
                                    <div class="mb-2">
                                        <div class="form-label">
                                            <span class="d-flex justify-content-between align-items-center"> Password
                                                <a class="text-primary" href="auth-password-reset.html">Forgot
                                                    Password?</a>
                                            </span>
                                        </div>
                                        <input id="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror" type="password"
                                ...
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted">Don't have an account yet? <a href="{{ route('register') }}">Sign
                                            up here</a></span>
                                </div>
                            </form>
                    ...
                    <div class="card fieldset border setting-mode mb-4">
                        ...
                        <div class="c_radio d-flex text-center">
                            ...
                            <label class="m-1 theme-dark" for="theme-dark">
                                ...
                                <span class="card p-2">
                                    <img class="img-fluid" src="{{url('/')}}/admin/assets/img/dark-theme.svg"
                                        alt="Theme Dark Mode" />
                                </span>
                            </label>
                            <label class="m-1 theme-high-contrast" for="theme-high-contrast">
                                ...
                                <span class="card p-2">
                                    <img class="img-fluid" src="{{url('/')}}/admin/assets/img/high-version.svg"
                                        alt="High Contrast" />
                                </span>
                            </label>
                                ...
                                <div class="bg-images">
                                    <ul class="list-unstyled d-flex">
                                        <li class="sidebar-img-1 me-1 sidebar-img-active"><a class="rounded sidebar-img"
                                                id="img-1" href="#"><img src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-1.jpg"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-2 me-1"><a class="rounded sidebar-img" id="img-2"
                                                href="#"><img src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-2.jpg"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-3 me-1"><a class="rounded sidebar-img" id="img-3"
                                                href="#"><img src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-3.jpg"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-4 me-1"><a class="rounded sidebar-img" id="img-4"
                                                href="#"><img src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-4.jpg"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-5 me-1"><a class="rounded sidebar-img" id="img-5"
                                                href="#"><img src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-5.jpg"
                                                    alt="" /></a></li>
                                    </ul>
                                </div>
                            </li>
