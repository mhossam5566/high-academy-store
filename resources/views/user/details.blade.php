                ...
                <div class="product-detail-card">
                    <div class="product-gallery">
                            ...
                            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="main-product-image" src="{{ $product->image_path }}" alt="{{ $product->name }}">
                                    </div>
                                    @foreach ($product->images as $image)
                                        <div class="carousel-item">
                                            <img class="main-product-image" src="{{ asset('storage/' . $image->image_path) }}" alt="صورة المنتج">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="carousel-thumbnails">
                            <img src="{{ $product->image_path }}" data-bs-target="#product-carousel" data-bs-slide-to="0" class="active" alt="صورة مصغرة">
                            @foreach ($product->images as $index => $image)
                                <img src="{{ asset('storage/' . $image->image_path) }}" data-bs-target="#product-carousel" data-bs-slide-to="{{ $index + 1 }}" alt="صورة مصغرة {{ $index + 1 }}">
                            @endforeach
                        </div>
                    </div>
                </div>
                                ...
                                <div id="colorChoices">
                                    @foreach($product->colors as $color)
                                        <label class="color-option">
                                            <input type="radio" name="selected_color{{$product->id}}" value="{{ $color }}">
                                            {{ $color }}
                                        </label>
                                    @endforeach
                                </div>
                                ...
                                <div id="sizeChoices">
                                    @foreach ($product->sizes as $size)
                                        <label class="size-option">
                                            <input type="radio" name="selected_size{{$product->id}}" value="{{ $size }}">
                                            {{ $size }}
                                        </label>
                                    @endforeach
                                </div>
...
if (product_carousel) {
    product_carousel.addEventListener('slid.bs.carousel', function (e) {
        ...
        document.querySelector('.carousel-thumbnails img.active').classList.remove('active');
        document.querySelector(`.carousel-thumbnails img[data-bs-slide-to="${active_index}"]`).classList.add('active');
    });
}
