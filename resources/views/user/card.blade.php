...
@section('content')
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;500;600;700;900&family=Amiri:wght@400;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        *::after {
        ...
        .card-section:hover {
            box-shadow: 0 8px 40px rgba(26, 18, 9, 0.13);
        }
        ...
        .coupon-strip input::placeholder {
            color: #C0B5A8;
        }
                                    ...
                                    <form id="order">
                                        @foreach (Cart::instance('shopping')->content() as $item)
                                            <tr>
                                                ...
                                                <td><span class="price-badge">{{ number_format($item->price, 2) }} ج</span>
                                                </td>
                        ...
                        <div class="card-body-custom">
                            ...
                            <form id="location-data">
                                ...
                                <div class="form-group-custom">
                                    ...
                                    <input class="form-control-custom" id="address" name="address"
                                        placeholder="مثال: شارع الجمهورية، أمام المسجد، الدور الثاني" />
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <div class="form-group-custom">
                                            ...
                                            <input class="form-control-custom" type="number" id="mobile"
                                                name="mobile" pattern="\d{11}" minlength="11" maxlength="11"
                            ...
                            <div class="shipping-method-wrapper">
                                ...
                                <div id="shipping_info" style="display: none;">
                                    <p id="fee_row"><strong>رسوم الخدمة:</strong> <span id="shipping_fee">0.00</span>
                                        جنيه</p>
                                    ...
                                    <p id="post_cost_row" style="display: none;">
                                        ...
                                        <a href="{{ route('user.fqa') }}" class="btn-pay"
                                            style="font-size:12px;padding:6px 14px;">تعرف على طريقة الاستلام</a>
                                    </p>
                                    <p id="address_row"><strong>العنوان:</strong> <span id="shipping_address">---</span>
                                    </p>
                                    <p id="phones_row"><strong>أرقام الهاتف:</strong> <span
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p style="color: var(--muted); margin-bottom:16px;">يتم إضافة رسوم 1% + 2.5 جنيه للدفع
                                        بفوري باي</p>
                                    <button type="button" class="btn-pay" id="fawry">اضغط لإكمال عملية
                                        الدفع</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="support-section">
                ...
                <div class="support-btns">
                    ...
                    <a href="https://www.facebook.com/highacademy2?mibextid=ZbWKwL" target="_blank"
                        class="btn-support btn-facebook">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                            <path
