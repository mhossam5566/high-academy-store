@push('pricing-script')
<script src="{{asset('dashboard/assets/js/pages-pricing.js')}}"></script>
@endpush
              ...
              <div class="card border rounded shadow-none">
                <div class="card-body">
                  <div class="my-3 pt-2 text-center">
                    <img src="{{asset('dashboard/assets/img/illustrations/page-pricing-basic.png') }}" alt="Basic Image" height="140">
                  </div>
            ...
            <div class="col-xl mb-md-0 mb-4">
              <div class="card border-primary border shadow-none">
                <div class="card-body position-relative">
                  ...
                  <div class="my-3 pt-2 text-center">
                    <img src="{{asset('dashboard/assets/img/illustrations/page-pricing-standard.png')}}" alt="Standard Image" height="140">
                  </div>
            ...
            <div class="col-xl">
              <div class="card border rounded shadow-none">
                <div class="card-body">
                  ...
                  <div class="my-3 pt-2 text-center">
                    <img src="{{asset('dashboard/assets/img/illustrations/page-pricing-enterprise.png')}}" alt="Enterprise Image" height="140">
                  </div>
