      ...
      <ul class="p-0 m-0">
        <li class="d-flex flex-wrap mb-3">
          <div class="avatar me-3">
            <img src="{{asset('dashboard/assets/img/avatars/1.png')}}" alt="avatar" class="rounded-circle">
          </div>
        ...
        <li class="d-flex flex-wrap mb-3">
          <div class="avatar me-3">
            <img src="{{asset('dashboard/assets/img/avatars/2.png')}}" alt="avatar" class="rounded-circle">
          </div>
          <div class="d-flex justify-content-between flex-grow-1">
            <div class="me-2">
        ...
        <li class="d-flex flex-wrap mb-3">
          <div class="avatar me-3">
            <img src="{{asset('dashboard/assets/img/avatars/3.png')}}" alt="avatar" class="rounded-circle">
          </div>
          <div class="d-flex justify-content-between flex-grow-1">
            <div class="me-2">
        ...
        <li class="d-flex flex-wrap mb-3">
          <div class="avatar me-3">
            <img src="{{asset('dashboard/assets/img/avatars/4.png')}}" alt="avatar" class="rounded-circle">
          </div>
          <div class="d-flex justify-content-between flex-grow-1">
            <div class="me-2">
        ...
        <li class="d-flex flex-wrap">
          <div class="avatar me-3">
            <img src="{{asset('dashboard/assets/img/avatars/8.png')}}" alt="avatar" class="rounded-circle">
          </div>
          <div class="d-flex justify-content-between flex-grow-1">
            <div class="me-2">
