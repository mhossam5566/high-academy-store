...
<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('dashboard/assets/vendor/css' . $configData['rtlSupport'] . '/core.css') }}"
    class="{{ $configData['hasCustomizer'] ? 'template-customizer-core-css' : '' }}" />
<link rel="stylesheet"
    href="{{ asset('dashboard/assets/vendor/css' . $configData['rtlSupport'] . '/' . $configData['theme'] . '.css') }}"
