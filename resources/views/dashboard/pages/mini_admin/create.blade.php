...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <h4 class="mb-0">
            <span class="text-muted fw-light">حسابات الأدمن الفرعي /</span> إضافة أدمن فرعي جديد
        </h4>
    </div>

    <form action="{{ route('dashboard.store.minadmin') }}" method="POST" data-validate class="needs-validation" novalidate
        ...
        <div class="card">
            <div class="card-body text-end">
                <button type="submit" class="btn btn-primary">حفظ الأدمن الفرعي</button>
            </div>
        </div>
