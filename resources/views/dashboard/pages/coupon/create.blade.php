                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti ti-ticket me-2"></i>معلومات الكوبون
                        </h5>
                    </div>
                    <div class="card-body">
                        <form id="couponForm" method="POST" action="{{ route('dashboard.coupons.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    <label class="form-label">
                                        <i class="ti ti-photo me-1"></i>صورة الكوبون
                                    </label>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="ti ti-device-floppy me-1"></i>حفظ الكوبون
                                </button>
                            </div>
                        </form>
                    </div>
