...
@section('content')
    ...
    <form id="brandForm" data-ajax data-redirect="{{ route('dashboard.teachers') }}"
        action="{{ route('dashboard.store.teachers') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="file" name="photo"
                            class="dropify form-control @error('photo') is-invalid @enderror" data-default-file=""
