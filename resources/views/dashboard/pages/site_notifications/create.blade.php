...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.site_notifications.store') }}" method="POST" id="notificationForm">
                @csrf
                <div class="mb-3">
