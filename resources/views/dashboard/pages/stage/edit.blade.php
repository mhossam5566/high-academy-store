...
@section('title', 'تعديل مرحلة تعليمية')
...
@section('content')
    ...
    <form action="{{ route('dashboard.stage.update') }}" method="POST" data-validate class="needs-validation" novalidate
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="title:{{ $locale }}"
                                        value="{{ optional($stage->translate($locale))->title }}">
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        ...
                        @if ($stage->image_path ?? false)
                            <div class="mt-2">
                                <img src="{{ $stage->image_path }}" alt="Stage image" class="rounded"
                                    style="height: 80px;">
                            </div>
                        @endif
                    </div>
