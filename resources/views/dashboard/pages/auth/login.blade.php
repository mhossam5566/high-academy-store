                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="{{ url('/') }}" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">@include('dashboard._partials.macros', [
                                    'height' => 20,
                                    'withbg' => 'fill: #fff;',
                                ])</span>
                                <span
                        ...
                        <form class="mb-3" action="{{ route('admin.signin') }}" method="post"
                            data-redirect='{{ route('dashboard.index') }}' data-ajax>
                            @csrf
                            <div class="mb-3">
