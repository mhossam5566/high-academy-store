    ...
    <div class="card">
        <div class="card-body">
            <form id="categoryForm" data-ajax data-redirect="{{ route('dashboard.category') }}"
                action="{{ route('dashboard.category.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title:{{ $locale }}"
                                            ...
                                            value="{{ $category->translate($locale)->title }}" data-validate
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="file" name="photo" data-default-file="{{ $category->image_path }}"
