...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">
                <i class="ti ti-shield-plus me-2"></i>إضافة دور وصلاحيات جديدة
            </h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="مثال: مدير الطلبات، مشرف المنتجات..." required>
                            @error('name')
            ...
            <div class="card mt-2">
                <div class="card-body d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4">
                        <i class="ti ti-device-floppy me-1"></i>حفظ الدور
                    </button>
                </div>
            </div>
        </form>
